...
def get_default_pipeline_and_parameters(
    ...
    evaluation_class_names: List[str] = ['0', '1'],
  ...
  Args:
    ...
    batch_predict_machine_type: The prediction server machine type
      for batch predict components during evaluation.
    batch_predict_starting_replica_count: The initial number of
      prediction server for batch predict components during evaluation.
    batch_predict_max_replica_count: The max number of prediction
